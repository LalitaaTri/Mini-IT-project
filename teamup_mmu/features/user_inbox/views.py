...
async def index(request):
    ...
    if request.method == "GET":
        ...
        async with pool.acquire() as conn:
            # 1. FETCH GROUP INVITES (Using old schema: no class joins)
...
async def inbox_approve_request(request, request_id):
    ...
    async with pool.acquire() as conn:
        ...
        # Removed class_id and teams_frozen logic because your local DB doesn't have class_id yet
